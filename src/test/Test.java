...
//		System.out.println(string);
	...
	public static void loadAllTableAndWriteAllModule(TableContext tableContext) {
		tableContext.loadDB();
		tableContext.createAppointedModuleFiles(new MysqlTypeConvertor(),new XMLMapperCreatorMySQL(false, false, false, false, false, false));
	}
	...
	public static void loadAppointedTableAndWriteAppointedModule(TableContext tableContext) {
		tableContext.loadDB("agency_xj", "fans_xj");
		tableContext.createAppointedModuleFiles(new MysqlTypeConvertor(),new XMLMapperCreatorMySQL(false, false, false, false, false, false), "Bean","Dao");
	}
