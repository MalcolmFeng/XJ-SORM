...
public abstract class Query implements Cloneable{
	 ...
	 * @param sql sql语句
	 * @param params  参数组
	 * @param clz  记录要封装到的java类Class对象
	 * @param cb  CallBack的实现类，匿名内部类，实现回调。
	 * @return 返回 回调方法的返回值
	 */
				...
				try{
					...
					while(rs.next()){
						...
						for(int i=0;i<metaData.getColumnCount();i++){
							...
							Method m = rowObj.getClass().getDeclaredMethod("set"+StringUtils.changeFirstToUpper(columnName), columnValue.getClass());
